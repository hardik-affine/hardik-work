...
template <class Protocol_>
class ThriftTestProcessorT : public ::apache::thrift::TProcessor {
 protected:
  boost::shared_ptr<ThriftTestIf> iface_;
  virtual bool process_fn(apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot, std::string& fname, int32_t seqid, void* callContext);
 private:
  std::map<std::string, void (ThriftTestProcessorT::*)(int32_t, apache::thrift::protocol::TProtocol*, apache::thrift::protocol::TProtocol*, void*)> processMap_;
 ...
 public:
  ThriftTestProcessorT(boost::shared_ptr<ThriftTestIf> iface) :
    iface_(iface) {
    processMap_["testVoid"] = &ThriftTestProcessorT::process_testVoid;
    processMap_["testString"] = &ThriftTestProcessorT::process_testString;
    processMap_["testByte"] = &ThriftTestProcessorT::process_testByte;
    processMap_["testI32"] = &ThriftTestProcessorT::process_testI32;
    processMap_["testI64"] = &ThriftTestProcessorT::process_testI64;
    processMap_["testDouble"] = &ThriftTestProcessorT::process_testDouble;
    processMap_["testStruct"] = &ThriftTestProcessorT::process_testStruct;
    processMap_["testNest"] = &ThriftTestProcessorT::process_testNest;
    processMap_["testMap"] = &ThriftTestProcessorT::process_testMap;
    processMap_["testStringMap"] = &ThriftTestProcessorT::process_testStringMap;
    processMap_["testSet"] = &ThriftTestProcessorT::process_testSet;
    processMap_["testList"] = &ThriftTestProcessorT::process_testList;
    processMap_["testEnum"] = &ThriftTestProcessorT::process_testEnum;
    processMap_["testTypedef"] = &ThriftTestProcessorT::process_testTypedef;
    processMap_["testMapMap"] = &ThriftTestProcessorT::process_testMapMap;
    processMap_["testInsanity"] = &ThriftTestProcessorT::process_testInsanity;
    processMap_["testMulti"] = &ThriftTestProcessorT::process_testMulti;
    processMap_["testException"] = &ThriftTestProcessorT::process_testException;
    processMap_["testMultiException"] = &ThriftTestProcessorT::process_testMultiException;
    processMap_["testOneway"] = &ThriftTestProcessorT::process_testOneway;
  }
...
class ThriftTestCobClIfT {
 public:
  ...
  virtual void testVoid(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob) = 0;
  virtual void testString(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& thing) = 0;
  virtual void testByte(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int8_t thing) = 0;
  virtual void testI32(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int32_t thing) = 0;
  virtual void testI64(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int64_t thing) = 0;
  virtual void testDouble(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const double thing) = 0;
  virtual void testStruct(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Xtruct& thing) = 0;
  virtual void testNest(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Xtruct2& thing) = 0;
  virtual void testMap(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::map<int32_t, int32_t> & thing) = 0;
  virtual void testStringMap(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::map<std::string, std::string> & thing) = 0;
  virtual void testSet(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::set<int32_t> & thing) = 0;
  virtual void testList(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::vector<int32_t> & thing) = 0;
  virtual void testEnum(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Numberz::type thing) = 0;
  virtual void testTypedef(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const UserId thing) = 0;
  virtual void testMapMap(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int32_t hello) = 0;
  virtual void testInsanity(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Insanity& argument) = 0;
  virtual void testMulti(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int8_t arg0, const int32_t arg1, const int64_t arg2, const std::map<int16_t, std::string> & arg3, const Numberz::type arg4, const UserId arg5) = 0;
  virtual void testException(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& arg) = 0;
  virtual void testMultiException(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& arg0, const std::string& arg1) = 0;
  virtual void testOneway(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int32_t secondsToSleep) = 0;
};
...
class ThriftTestCobSvIf {
 public:
  ...
  virtual void testVoid(std::tr1::function<void()> cob) = 0;
  virtual void testString(std::tr1::function<void(std::string const& _return)> cob, const std::string& thing) = 0;
  virtual void testByte(std::tr1::function<void(int8_t const& _return)> cob, const int8_t thing) = 0;
  virtual void testI32(std::tr1::function<void(int32_t const& _return)> cob, const int32_t thing) = 0;
  virtual void testI64(std::tr1::function<void(int64_t const& _return)> cob, const int64_t thing) = 0;
  virtual void testDouble(std::tr1::function<void(double const& _return)> cob, const double thing) = 0;
  virtual void testStruct(std::tr1::function<void(Xtruct const& _return)> cob, const Xtruct& thing) = 0;
  virtual void testNest(std::tr1::function<void(Xtruct2 const& _return)> cob, const Xtruct2& thing) = 0;
  virtual void testMap(std::tr1::function<void(std::map<int32_t, int32_t>  const& _return)> cob, const std::map<int32_t, int32_t> & thing) = 0;
  virtual void testStringMap(std::tr1::function<void(std::map<std::string, std::string>  const& _return)> cob, const std::map<std::string, std::string> & thing) = 0;
  virtual void testSet(std::tr1::function<void(std::set<int32_t>  const& _return)> cob, const std::set<int32_t> & thing) = 0;
  virtual void testList(std::tr1::function<void(std::vector<int32_t>  const& _return)> cob, const std::vector<int32_t> & thing) = 0;
  virtual void testEnum(std::tr1::function<void(Numberz::type const& _return)> cob, const Numberz::type thing) = 0;
  virtual void testTypedef(std::tr1::function<void(UserId const& _return)> cob, const UserId thing) = 0;
  virtual void testMapMap(std::tr1::function<void(std::map<int32_t, std::map<int32_t, int32_t> >  const& _return)> cob, const int32_t hello) = 0;
  virtual void testInsanity(std::tr1::function<void(std::map<UserId, std::map<Numberz::type, Insanity> >  const& _return)> cob, const Insanity& argument) = 0;
  virtual void testMulti(std::tr1::function<void(Xtruct const& _return)> cob, const int8_t arg0, const int32_t arg1, const int64_t arg2, const std::map<int16_t, std::string> & arg3, const Numberz::type arg4, const UserId arg5) = 0;
  virtual void testException(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& arg) = 0;
  virtual void testMultiException(std::tr1::function<void(Xtruct const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& arg0, const std::string& arg1) = 0;
  virtual void testOneway(std::tr1::function<void()> cob, const int32_t secondsToSleep) = 0;
};
...
class ThriftTestCobSvNull : virtual public ThriftTestCobSvIf {
 public:
  ...
  void testVoid(std::tr1::function<void()> cob) {
    return cob();
  }
  void testString(std::tr1::function<void(std::string const& _return)> cob, const std::string& /* thing */) {
    std::string _return = "";
    return cob(_return);
  }
  void testByte(std::tr1::function<void(int8_t const& _return)> cob, const int8_t /* thing */) {
    int8_t _return = 0;
    return cob(_return);
  }
  void testI32(std::tr1::function<void(int32_t const& _return)> cob, const int32_t /* thing */) {
    int32_t _return = 0;
    return cob(_return);
  }
  void testI64(std::tr1::function<void(int64_t const& _return)> cob, const int64_t /* thing */) {
    int64_t _return = 0;
    return cob(_return);
  }
  void testDouble(std::tr1::function<void(double const& _return)> cob, const double /* thing */) {
    double _return = (double)0;
    return cob(_return);
  }
  void testStruct(std::tr1::function<void(Xtruct const& _return)> cob, const Xtruct& /* thing */) {
    Xtruct _return;
    return cob(_return);
  }
  void testNest(std::tr1::function<void(Xtruct2 const& _return)> cob, const Xtruct2& /* thing */) {
    Xtruct2 _return;
    return cob(_return);
  }
  void testMap(std::tr1::function<void(std::map<int32_t, int32_t>  const& _return)> cob, const std::map<int32_t, int32_t> & /* thing */) {
    std::map<int32_t, int32_t>  _return;
    return cob(_return);
  }
  void testStringMap(std::tr1::function<void(std::map<std::string, std::string>  const& _return)> cob, const std::map<std::string, std::string> & /* thing */) {
    std::map<std::string, std::string>  _return;
    return cob(_return);
  }
  void testSet(std::tr1::function<void(std::set<int32_t>  const& _return)> cob, const std::set<int32_t> & /* thing */) {
    std::set<int32_t>  _return;
    return cob(_return);
  }
  void testList(std::tr1::function<void(std::vector<int32_t>  const& _return)> cob, const std::vector<int32_t> & /* thing */) {
    std::vector<int32_t>  _return;
    return cob(_return);
  }
  void testEnum(std::tr1::function<void(Numberz::type const& _return)> cob, const Numberz::type /* thing */) {
    Numberz::type _return = (Numberz::type)0;
    return cob(_return);
  }
  void testTypedef(std::tr1::function<void(UserId const& _return)> cob, const UserId /* thing */) {
    UserId _return = 0;
    return cob(_return);
  }
  void testMapMap(std::tr1::function<void(std::map<int32_t, std::map<int32_t, int32_t> >  const& _return)> cob, const int32_t /* hello */) {
    std::map<int32_t, std::map<int32_t, int32_t> >  _return;
    return cob(_return);
  }
  void testInsanity(std::tr1::function<void(std::map<UserId, std::map<Numberz::type, Insanity> >  const& _return)> cob, const Insanity& /* argument */) {
    std::map<UserId, std::map<Numberz::type, Insanity> >  _return;
    return cob(_return);
  }
  void testMulti(std::tr1::function<void(Xtruct const& _return)> cob, const int8_t /* arg0 */, const int32_t /* arg1 */, const int64_t /* arg2 */, const std::map<int16_t, std::string> & /* arg3 */, const Numberz::type /* arg4 */, const UserId /* arg5 */) {
    Xtruct _return;
    return cob(_return);
  }
  void testException(std::tr1::function<void()> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* arg */) {
    return cob();
  }
  void testMultiException(std::tr1::function<void(Xtruct const& _return)> cob, std::tr1::function<void(::apache::thrift::TDelayedException* _throw)> /* exn_cob */, const std::string& /* arg0 */, const std::string& /* arg1 */) {
    Xtruct _return;
    return cob(_return);
  }
  void testOneway(std::tr1::function<void()> cob, const int32_t /* secondsToSleep */) {
    return cob();
  }
};
...
class ThriftTestCobClientT : virtual public ThriftTestCobClIfT<Protocol_> {
 public:
  ...
  void testVoid(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob);
  void send_testVoid();
  void recv_testVoid();
  void testString(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& thing);
  void send_testString(const std::string& thing);
  void recv_testString(std::string& _return);
  void testByte(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int8_t thing);
  void send_testByte(const int8_t thing);
  int8_t recv_testByte();
  void testI32(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int32_t thing);
  void send_testI32(const int32_t thing);
  int32_t recv_testI32();
  void testI64(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int64_t thing);
  void send_testI64(const int64_t thing);
  int64_t recv_testI64();
  void testDouble(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const double thing);
  void send_testDouble(const double thing);
  double recv_testDouble();
  void testStruct(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Xtruct& thing);
  void send_testStruct(const Xtruct& thing);
  void recv_testStruct(Xtruct& _return);
  void testNest(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Xtruct2& thing);
  void send_testNest(const Xtruct2& thing);
  void recv_testNest(Xtruct2& _return);
  void testMap(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::map<int32_t, int32_t> & thing);
  void send_testMap(const std::map<int32_t, int32_t> & thing);
  void recv_testMap(std::map<int32_t, int32_t> & _return);
  void testStringMap(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::map<std::string, std::string> & thing);
  void send_testStringMap(const std::map<std::string, std::string> & thing);
  void recv_testStringMap(std::map<std::string, std::string> & _return);
  void testSet(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::set<int32_t> & thing);
  void send_testSet(const std::set<int32_t> & thing);
  void recv_testSet(std::set<int32_t> & _return);
  void testList(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::vector<int32_t> & thing);
  void send_testList(const std::vector<int32_t> & thing);
  void recv_testList(std::vector<int32_t> & _return);
  void testEnum(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Numberz::type thing);
  void send_testEnum(const Numberz::type thing);
  Numberz::type recv_testEnum();
  void testTypedef(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const UserId thing);
  void send_testTypedef(const UserId thing);
  UserId recv_testTypedef();
  void testMapMap(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int32_t hello);
  void send_testMapMap(const int32_t hello);
  void recv_testMapMap(std::map<int32_t, std::map<int32_t, int32_t> > & _return);
  void testInsanity(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const Insanity& argument);
  void send_testInsanity(const Insanity& argument);
  void recv_testInsanity(std::map<UserId, std::map<Numberz::type, Insanity> > & _return);
  void testMulti(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int8_t arg0, const int32_t arg1, const int64_t arg2, const std::map<int16_t, std::string> & arg3, const Numberz::type arg4, const UserId arg5);
  void send_testMulti(const int8_t arg0, const int32_t arg1, const int64_t arg2, const std::map<int16_t, std::string> & arg3, const Numberz::type arg4, const UserId arg5);
  void recv_testMulti(Xtruct& _return);
  void testException(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& arg);
  void send_testException(const std::string& arg);
  void recv_testException();
  void testMultiException(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const std::string& arg0, const std::string& arg1);
  void send_testMultiException(const std::string& arg0, const std::string& arg1);
  void recv_testMultiException(Xtruct& _return);
  void testOneway(std::tr1::function<void(ThriftTestCobClientT<Protocol_>* client)> cob, const int32_t secondsToSleep);
  void send_testOneway(const int32_t secondsToSleep);
 protected:
...
template <class Protocol_>
class ThriftTestAsyncProcessorT : public ::apache::thrift::TAsyncProcessor {
 protected:
  boost::shared_ptr<ThriftTestCobSvIf> iface_;
 ...
 private:
  std::map<std::string, void (ThriftTestAsyncProcessorT::*)(std::tr1::function<void(bool ok)>, int32_t, apache::thrift::protocol::TProtocol*, apache::thrift::protocol::TProtocol*)> processMap_;
  void process_testVoid(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testVoid(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testVoid(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void return_testVoid(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx);
  void throw_testVoid(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testVoid(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testString(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testString(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testString(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void return_testString(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::string& _return);
  void throw_testString(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testString(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testByte(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testByte(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testByte(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int8_t& _return);
  void return_testByte(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int8_t& _return);
  void throw_testByte(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testByte(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testI32(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testI32(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testI32(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return);
  void return_testI32(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return);
  void throw_testI32(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testI32(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testI64(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testI64(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testI64(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int64_t& _return);
  void return_testI64(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int64_t& _return);
  void throw_testI64(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testI64(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testDouble(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testDouble(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testDouble(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const double& _return);
  void return_testDouble(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const double& _return);
  void throw_testDouble(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testDouble(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testStruct(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testStruct(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testStruct(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const Xtruct& _return);
  void return_testStruct(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const Xtruct& _return);
  void throw_testStruct(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testStruct(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testNest(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testNest(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testNest(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const Xtruct2& _return);
  void return_testNest(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const Xtruct2& _return);
  void throw_testNest(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testNest(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::map<int32_t, int32_t> & _return);
  void return_testMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::map<int32_t, int32_t> & _return);
  void throw_testMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testStringMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testStringMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testStringMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::map<std::string, std::string> & _return);
  void return_testStringMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::map<std::string, std::string> & _return);
  void throw_testStringMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testStringMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testSet(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testSet(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testSet(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::set<int32_t> & _return);
  void return_testSet(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::set<int32_t> & _return);
  void throw_testSet(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testSet(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testList(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testList(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testList(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<int32_t> & _return);
  void return_testList(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::vector<int32_t> & _return);
  void throw_testList(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testList(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testEnum(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testEnum(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testEnum(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const Numberz::type& _return);
  void return_testEnum(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const Numberz::type& _return);
  void throw_testEnum(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testEnum(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testTypedef(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testTypedef(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testTypedef(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const UserId& _return);
  void return_testTypedef(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const UserId& _return);
  void throw_testTypedef(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testTypedef(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testMapMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testMapMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testMapMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::map<int32_t, std::map<int32_t, int32_t> > & _return);
  void return_testMapMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::map<int32_t, std::map<int32_t, int32_t> > & _return);
  void throw_testMapMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testMapMap(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testInsanity(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testInsanity(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testInsanity(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::map<UserId, std::map<Numberz::type, Insanity> > & _return);
  void return_testInsanity(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::map<UserId, std::map<Numberz::type, Insanity> > & _return);
  void throw_testInsanity(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testInsanity(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testMulti(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testMulti(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testMulti(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const Xtruct& _return);
  void return_testMulti(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const Xtruct& _return);
  void throw_testMulti(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testMulti(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testException(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testException(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testException(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void return_testException(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx);
  void throw_testException(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testException(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testMultiException(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testMultiException(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testMultiException(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const Xtruct& _return);
  void return_testMultiException(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const Xtruct& _return);
  void throw_testMultiException(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testMultiException(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_testOneway(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_testOneway(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_testOneway(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void return_testOneway(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx);
  void throw_testOneway(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_testOneway(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
  ThriftTestAsyncProcessorT(boost::shared_ptr<ThriftTestCobSvIf> iface) :
    iface_(iface) {
    processMap_["testVoid"] = &ThriftTestAsyncProcessorT::process_testVoid;
    processMap_["testString"] = &ThriftTestAsyncProcessorT::process_testString;
    processMap_["testByte"] = &ThriftTestAsyncProcessorT::process_testByte;
    processMap_["testI32"] = &ThriftTestAsyncProcessorT::process_testI32;
    processMap_["testI64"] = &ThriftTestAsyncProcessorT::process_testI64;
    processMap_["testDouble"] = &ThriftTestAsyncProcessorT::process_testDouble;
    processMap_["testStruct"] = &ThriftTestAsyncProcessorT::process_testStruct;
    processMap_["testNest"] = &ThriftTestAsyncProcessorT::process_testNest;
    processMap_["testMap"] = &ThriftTestAsyncProcessorT::process_testMap;
    processMap_["testStringMap"] = &ThriftTestAsyncProcessorT::process_testStringMap;
    processMap_["testSet"] = &ThriftTestAsyncProcessorT::process_testSet;
    processMap_["testList"] = &ThriftTestAsyncProcessorT::process_testList;
    processMap_["testEnum"] = &ThriftTestAsyncProcessorT::process_testEnum;
    processMap_["testTypedef"] = &ThriftTestAsyncProcessorT::process_testTypedef;
    processMap_["testMapMap"] = &ThriftTestAsyncProcessorT::process_testMapMap;
    processMap_["testInsanity"] = &ThriftTestAsyncProcessorT::process_testInsanity;
    processMap_["testMulti"] = &ThriftTestAsyncProcessorT::process_testMulti;
    processMap_["testException"] = &ThriftTestAsyncProcessorT::process_testException;
    processMap_["testMultiException"] = &ThriftTestAsyncProcessorT::process_testMultiException;
    processMap_["testOneway"] = &ThriftTestAsyncProcessorT::process_testOneway;
  }
