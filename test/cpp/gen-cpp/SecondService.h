...
template <class Protocol_>
class SecondServiceProcessorT : public ::apache::thrift::TProcessor {
 protected:
  boost::shared_ptr<SecondServiceIf> iface_;
  virtual bool process_fn(apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot, std::string& fname, int32_t seqid, void* callContext);
 private:
  std::map<std::string, void (SecondServiceProcessorT::*)(int32_t, apache::thrift::protocol::TProtocol*, apache::thrift::protocol::TProtocol*, void*)> processMap_;
 ...
 public:
  SecondServiceProcessorT(boost::shared_ptr<SecondServiceIf> iface) :
    iface_(iface) {
    processMap_["blahBlah"] = &SecondServiceProcessorT::process_blahBlah;
  }
...
class SecondServiceCobClIfT {
 public:
  ...
  virtual void blahBlah(std::tr1::function<void(SecondServiceCobClientT<Protocol_>* client)> cob) = 0;
};
...
class SecondServiceCobSvIf {
 public:
  ...
  virtual void blahBlah(std::tr1::function<void()> cob) = 0;
};
...
class SecondServiceCobSvNull : virtual public SecondServiceCobSvIf {
 public:
  ...
  void blahBlah(std::tr1::function<void()> cob) {
    return cob();
  }
};
...
class SecondServiceCobClientT : virtual public SecondServiceCobClIfT<Protocol_> {
 public:
  ...
  void blahBlah(std::tr1::function<void(SecondServiceCobClientT<Protocol_>* client)> cob);
  void send_blahBlah();
  void recv_blahBlah();
 protected:
...
template <class Protocol_>
class SecondServiceAsyncProcessorT : public ::apache::thrift::TAsyncProcessor {
 protected:
  boost::shared_ptr<SecondServiceCobSvIf> iface_;
 ...
 private:
  std::map<std::string, void (SecondServiceAsyncProcessorT::*)(std::tr1::function<void(bool ok)>, int32_t, apache::thrift::protocol::TProtocol*, apache::thrift::protocol::TProtocol*)> processMap_;
  void process_blahBlah(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* iprot, apache::thrift::protocol::TProtocol* oprot);
  void process_blahBlah(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot);
  void return_blahBlah(std::tr1::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void return_blahBlah(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx);
  void throw_blahBlah(std::tr1::function<void(bool ok)> cob, int32_t seqid, apache::thrift::protocol::TProtocol* oprot, void* ctx, apache::thrift::TDelayedException* _throw);
  void throw_blahBlah(std::tr1::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
  SecondServiceAsyncProcessorT(boost::shared_ptr<SecondServiceCobSvIf> iface) :
    iface_(iface) {
    processMap_["blahBlah"] = &SecondServiceAsyncProcessorT::process_blahBlah;
  }
