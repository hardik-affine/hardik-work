...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/lib/erl/src/thrift.app.src.in NEWS config.guess \
...
CONFIG_CLEAN_FILES = lib/erl/src/thrift.app.src
...
ZLIB_LDFLAGS = 
ZLIB_LIBS = -lz
abs_builddir = /home/hardik/stuff/thrift-0.8.0
abs_srcdir = /home/hardik/stuff/thrift-0.8.0
...
lib/erl/src/thrift.app.src: $(top_builddir)/config.status $(top_srcdir)/lib/erl/src/thrift.app.src.in
